...
PROD-CONN_STR=postgres://postgres:artis12345@artis.cb8i8sw2y7l0.eu-west-3.rds.amazonaws.com:5432/postgres?search_path=public
...
e2e-test:
	go test -v ./internal/.../e2e_test/...
load-test:
	go test -timeout 960s -v ./internal/.../load_test/...
