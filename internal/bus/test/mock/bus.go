...
import (
	bus "escalateservice/internal/bus"
	reflect "reflect"
...
func (mr *MockExternalBusMockRecorder) Publish(event interface{}) *gomock.Call {
...
func (mr *MockEventHandlerMockRecorder) Handle(event interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
